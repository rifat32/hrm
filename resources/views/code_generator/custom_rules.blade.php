<div class="container">
    <h1 class="text-center mt-5">Custom Rule</h1>
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <div class="code-snippet">
                <h3>Create Rule Validate{{$names["singular_model_name"]}}Name</h3>
                <pre id="create_validate_{{$names["singular_table_name"]}}_name"><code>
php artisan make:rule Validate{{$names["singular_model_name"]}}Name
      </code></pre>
                <button class="copy-button" onclick="copyToClipboard('create_validate_{{$names['singular_table_name']}}_name')">Copy</button>
            </div>
            ...
            <div class="code-snippet">
              ...
              <button class="copy-button" onclick="copyToClipboard('validate_{{$names['singular_table_name']}}_name')">Copy</button>
          </div>
