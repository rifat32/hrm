...
class DesignationController extends Controller
{
     ...
     *      operationId="createDesignations",
 ...
 *
    ...
    public function createDesignations(DesignationCreateRequest $request)
    {
        try {
     ...
     * @OA\Put(
     *      path="/v1.0/designations",
     *      operationId="updateDesignations",
     *      tags={"administrator.designations"},
     *       security={
     *           {"bearerAuth": {}}
     *       },
 ...
 * @OA\Property(property="description", type="string", format="string", example="erg ear ga&nbsp;")
    ...
    public function updateDesignations(DesignationUpdateRequest $request)
    {
     ...
     *      operationId="getDesignationsById",
     *      tags={"administrator.designations"},
     *       security={
     *           {"bearerAuth": {}}
     *       },
    ...
    public function getDesignationsById($id, Request $request)
    {
        try {
            $this->storeActivity($request, "");
            if (!$request->user()->hasPermissionTo('designation_view')) {
